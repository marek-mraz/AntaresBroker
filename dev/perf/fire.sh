...
read -r ENT SUB REG NTEN < <(python3 dev/perf/tenant-counts.py "$BROKER_URL")
{
  echo "In the broker: $ENT entities, $SUB subscriptions, $REG registrations over $NTEN tenants."
  echo
