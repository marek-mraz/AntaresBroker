...
/// nothing is left to expand. The entity query, the temporal query and a
/// Subscription's notification condition (Table 5.2.12-1) all carry the
/// pair, and all three read it here.
