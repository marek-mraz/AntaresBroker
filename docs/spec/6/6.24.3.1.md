...
pages: '339'
status: implemented
evidence: POST /temporal/entityOperations/query (5.2.23 temporal reading incl. temporalQ 5.2.21 + aggrParams
  5.2.44); TP 021_27 green today
notes: binding confirmation — behaviour at 5.7.4 (POST form).
robot: []
---
