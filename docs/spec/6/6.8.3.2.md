...
pages: 303-305
status: implemented
evidence: 'GET /csourceRegistrations → csource::query_registrations (5.10.2: csf over source properties,
  scopeQ, geoquery, pagination); Discovery TP tree green today'
notes: binding confirmation — behaviour at 5.10.2.
robot: []
---
