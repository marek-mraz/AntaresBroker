...
pages: 358-359
status: implemented
evidence: lib.rs route DELETE /snapshots -> snapshots::purge_snapshots (5.16.7 audit); TP 5161_01 (4 cases,
  local memory-store run 4/4 green 2026-08-12) 5161_01_03/_04
notes: audited 2026-08-12 (Snapshot API built — the optional group is now OFFERED). Binding confirmation
  — behaviour audited at 5.16.7.
robot: []
---
