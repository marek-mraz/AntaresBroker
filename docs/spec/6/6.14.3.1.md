...
pages: 317-318
status: implemented
evidence: 'POST /entityOperations/create → batch::batch_create (5.6.7 audit: null-item 400, per-item @context, 201/204 all-ok vs 207 S+E arrays, federation ladder); BatchEntities TP tree green today'
notes: 'audited 2026-08-12: binding confirmation — behaviour at 5.6.7.'
robot: []
---
