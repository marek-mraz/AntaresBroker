...
pages: 272-273
status: implemented
evidence: 'repr.rs parse_repr: format=normalized|concise|simplified(|keyValues synonym) + the deprecated
  options-keyword alternative, first-value-wins; representations themselves recorded at 4.5.1-4.5.4/4.5.17;
  TPs 018_04/018_05/018_15/018_16 green locally'
notes: the 501-for-registered-Context-Sources arm is vacuous — Antares supports all representations as
  a source.
robot:
- 018_04
- 018_05
