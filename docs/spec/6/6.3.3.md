...
pages: 269-270
status: implemented
evidence: 'negotiate.rs impl IntoResponse for ApiError (application/json + 6.3.2 status + 5.5.3 RFC 7807 body); unit test error_body_shape_and_mime asserts all three bullets'
