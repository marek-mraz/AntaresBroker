...
pages: 361-362
status: implemented
evidence: lib.rs route POST /snapshots/{id}/clone -> snapshots::clone_snapshot (5.16.2 audit); TP 5161_01
  (4 cases, local memory-store run 4/4 green 2026-08-12) 5161_01_03
notes: audited 2026-08-12 (Snapshot API built — the optional group is now OFFERED). Binding confirmation
  — behaviour audited at 5.16.2.
robot: []
---
