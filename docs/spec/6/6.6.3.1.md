...
pages: 295-296
status: implemented
evidence: 'POST /entities/{id}/attrs → attrs::append_attrs (5.6.3: noOverwrite option, 207 partial, type
  selector); EntityAttributes TP tree green today'
notes: binding confirmation — behaviour at 5.6.3.
robot: []
---
