...
pages: 164-165
status: implemented
evidence: 'attrs.rs partial_update_inner: EntityId::new, check_attr_name (4.6.2), ?type selector, Attribute Fragment via expand_attr_fragment (no type inference, nulls allowed per 5.5.8; nested compound nulls rejected per 5.5.4).'
