...
pages: '104'
status: informative
evidence: 'Chapter heading — data structures and operations defined in the subclauses; the HTTP binding mapping is clause 6.'
notes: 'audited 2026-08-11: heading only, nothing to implement.'
robot: []
---
