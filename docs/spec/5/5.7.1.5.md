...
pages: 198-199
status: partial
evidence: 'respond/compact_for + apply (pick/omit reduction 4.21), VocabProperty compaction (4.5.20), lang -> Property conversion with lang subproperty (4.15), inline entity/entityList subproperties + flat array output (4.5.23), GeoJSON Feature/FeatureCollection (5.2.29/5.2.30). Asserted across the chapter-4 audits and the 018/5711_01 TP runs.'
