...
pages: 203-204
status: implemented
evidence: query response carries the EntityMap location (NGSILD-EntityMap header, 201 on creation) since
  the 5.14 build; tests clause_5_14_4_entity_map_true_on_query; TP 5144_01
notes: '2026-08-12: reconciled after the 5.14 EntityMaps build — the named gap is closed.'
robot: []
---
