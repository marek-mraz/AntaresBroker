...
notes: 'audited 2026-08-11: the value-space half of the table was unenforced (tolerant reader swallowed operations/localOnly/alias/refreshRate/datasetId/scope/geometries/name-strings) - all added. management member (5.2.34) and RegistrationManagementInfo defaults audit at their own clauses.
