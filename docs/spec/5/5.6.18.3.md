...
pages: '189'
status: implemented
evidence: 'entities.rs replace_entity: id URI + body-id match, ?type selector (wired), Entity per 5.2.4
  (ExpandOpts::default — NGSI-LD Nulls NOT supported on replace, per the clause).'
notes: ''
robot: []
---
