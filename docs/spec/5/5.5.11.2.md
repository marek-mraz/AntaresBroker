...
notes: 'audited 2026-08-11. Temporal-evolution "all instances shall be taken into account": each round
  is a separate store mutate with its own change emission, so the temporal mirror records every instance;
  asserted end-to-end at the 5.6.8/5.6.20 audits.'
robot:
- '466_01'
---
