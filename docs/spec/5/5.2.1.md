...
evidence: 'Data-type intro SHALLs: (1) NGSI-LD Null outside partial-update/merge inputs -> BadRequestData:
  ...
  2026-08-11 before the guard; marker survival on allow_null inputs). TP 521_01 3/3 + merge/partial regression
  056_01-04 + 012_01 + 001_01 26/26 green vs local memory broker 2026-08-11.'
notes: 'audited 2026-08-11. Fixed during audit: the NGSI-LD Null was creatable in plain values/objects
  (only languageMap was gated, 4.6.5). The JSON-literal-null alternative ({"@type":"@json","@value":null})
  is representable via JsonProperty json members (4.5.24).'
robot:
- '521_01'
---
