...
pages: '211'
status: implemented
evidence: 'respond_list of 5.2.20 Temporal Evolutions (present_temporal), pick/omit reduction, Content-Range 206 partial window (6.3.10), orderBy id ordering applied pre-pagination; lang (6.18.3.2-1) reduces LanguageProperty instances via repr::apply_lang (tests/temporal_lang_5_7_4.rs, Robot 5744_07, IOP_EXT_TMP_04_01).'
