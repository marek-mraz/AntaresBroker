...
pages: 74-75
status: implemented
evidence: 'expand.rs concise inference: type-less object with "vocab" infers VocabProperty; the
  shared prohibition guards apply after inference. Unit test: vocab_property_rules
  (concise case).'
