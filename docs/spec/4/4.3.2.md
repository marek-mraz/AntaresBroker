...
status: informative
evidence: ''
notes: 'Prose description of Figure 4.3.2-1 (central broker, producers update, consumers query/subscribe).
  Zero SHALLs, no observable API behaviour of its own — the operations it names are recorded under their
  §5 clauses. Rule-9 verdict: architecture umbrella, zero code.'
robot: []
---
