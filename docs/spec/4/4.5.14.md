...
pages: 66-67
status: implemented
evidence: 'antares-api/src/types_attrs.rs attributes() details=true branch: array of objects with
  id = attribute URI, fixed type "Attribute", attributeName (short name), typeNames of
  entity types. Integration test: discovery::attribute_representations_shapes (negative
  check included; proven fallible). Official TP 026_01 green against the local memory broker
  2026-08-10.'
