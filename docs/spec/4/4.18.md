...
evidence: 'antares-jsonld/src/expand.rs scope branch: string-or-array shape + full 4.18 grammar validation
  ...
  update replaces; temporal reified scope instances = 4.5.6 audit (Core-API scope changes recorded with
  observedAt=modifiedAt). Unit expand::clause_4_18 (EXAMPLES 1-4 + 7 rejection shapes + array poisoning;
  red seen 2026-08-11 — the grammar was not enforced at all). TPs: official 001_11/004_03/010_07/011_05/013_04/020_19/020_20/054_03
  15/15 + extension 418_01 (grammar 400s incl. null-on-create) 6/6 green vs local memory broker 2026-08-11.'
notes: '2026-08-13: temporal validity semantics implemented — scopeQ on 5.7.4.4 matches scope validity intervals (set until replaced/removed, C.5.16), and temporal input (5.6.11) accepts the 4.5.6 instance-shaped scope (expand.rs temporal arm). Tests tests/temporal_scope_5_7_4.rs. audited 2026-08-11. Fixed during audit: the Scope grammar was unenforced — "9bad", "a//b", "a-b"
  and "urn:ngsi-ld:null" were all creatable. Distributed scope-merge (values of scope are merged when
  combining distributed results) is exercised by the federation merge path (4.5.5.3 merge_docs); scopeQ
  filtering is 4.19, next.'
robot:
- '001_11'
- '004_03'
- '010_07'
