...
evidence: 'crates/antares-api/src/conformance.rs implements Tables 4.3.6.8-1/2/3: amend_entity/amend_attr
  ...
  show_changes_previous_members_are_values_not_sub_attributes — 6/6 green. The tables govern Attributes
  and their sub-Attributes; the 5.2.14 previous* members are not Attributes but the VALUE the Attribute
  held ("any JSON value" per Table 4.3.6.8-2, String or String[] per Table 4.3.6.8-3), so they carry
  through untouched instead of taking Notes 2/3. Extension TP 436_08 (Prefer 1.5 reformat + native no-op) green locally 2026-08-10.'
