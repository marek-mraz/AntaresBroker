...
pages: 69-70
status: implemented
evidence: 'antares-jsonld/src/expand.rs: LanguageProperty is a first-class ATTR_TYPES member;
  normalized (4.5.18.2) and concise (4.5.18.3) forms both expand through expand_instance.
  Representation selection (normalized/concise/simplified) is the repr.rs transform. Unit
  test: expand::tests::language_property_rules. Official TPs (011_07-09, 012_04-07, 001_10,
  010_06, 402_01 — 31 cases) green against the local memory broker 2026-08-10.'
