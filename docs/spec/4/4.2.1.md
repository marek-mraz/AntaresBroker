...
status: informative
evidence: ''
notes: 'Audited 2026-08-10. Descriptive introduction to the two-level information model (Figure 4.2.1-1). Its SHALLs ("structure ... shall be supported", "representation mechanisms ... shall be used") delegate to the Core Meta-model (4.2.2, audited: required-member checks at expansion) and Cross-Domain Ontology (4.2.3, audited: delegation note). Domain ontologies (SAREF etc.) are deployment content, not broker code (rule-9 posture).'
robot:
- '021_21'
- '021_22'
---
