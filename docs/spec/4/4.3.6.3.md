...
evidence: 'crates/antares-api/src/csource.rs: validate_exclusive (exclusive shall define entity id + Attributes;
  ...
  TPs all green locally 2026-08-10 (62 tests).'
notes: 'Audited 2026-08-10 — closes the claude.md §6 item-2 validation gap. Conflict errors travel as
  AlreadyExists/409 (Table 6.3.2-1 defines no Conflict type; standing federation.rs precedent). 5.9.2''s
  further exclusive/redirect restrictions (Conflict when a matching ENTITY already exists) are 5.9.2 surface,
  audited there. SUITE DEFECT logged (error.md + testsuite-doubts.md 2026-08-10): 9 official _exc TPs
  created 4.3.6.3-invalid exclusives (attr-less or idPattern-scoped); fork fixed, to be raised upstream.'
robot:
- '436_03'
- D001_01_exc
- D001_01_red
