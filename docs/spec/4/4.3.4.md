...
status: informative
evidence: ''
notes: 'Audited 2026-08-10. Prose description of Figure 4.3.4-1: federation = the
  distributed pattern with whole domains registered coarse-grained (scopes, geo
  scopes) instead of individual Context Sources. Zero SHALLs — registration matching,
  forwarding and aggregation are audited under 4.3.6.x, 5.9.x/5.10.x and the
  distributed-operation clauses. Rule-9 verdict: architecture umbrella, zero code.'
robot: []
---
