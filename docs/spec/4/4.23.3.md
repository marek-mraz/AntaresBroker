...
evidence: 'entities.rs order_entities parser: OrderingTerm *(thenOp OrderingTerm) with thenOp='',''; directions
  ...
  8-10). Unit clause_4_23 + TP 423_01. collation CLOSED entities.rs build_collator (ICU4X icu_collator;
...
notes: collation CLOSED entities.rs build_collator (ICU4X icu_collator; RFC 6067 tag, -u-ks strength via
  CollatorOptions, co/kf/kn via CollatorPreferences) wired into order_entities cmp_vals; invalid tag ->
  400. tests/collation_4_23.rs (4, red->green) + TP 4233_01.
robot:
- '4233_01'
---
