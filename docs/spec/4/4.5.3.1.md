...
evidence: 'crates/antares-api/src/repr.rs: both representations supported and
  consumer-selectable (options=concise|normalized, format parameter) — the same
  machinery evidenced for 4.5.2.1; Relationships flow through the identical
  render path.'
notes: 'Audited 2026-08-10. Mirror of 4.5.2.1 for Relationships — the one SHALL
  delegates to 4.5.3.2 (normalized) and 4.5.3.3 (concise); request-parameter
  surface audited under 6.3.7.'
robot: []
---
