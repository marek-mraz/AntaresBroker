...
pages: 35-40
status: implemented
evidence: Core + Distributed API operation clauses all audited under their own files; /entityMaps + /temporal/entityMaps
  routes exist since the 5.14 build (entity_maps.rs); Snapshot API offered since 2026-08-12 (snapshots.rs; Table
  4.3.5-2, staged-v1x)
notes: '2026-08-12: reconciled after the 5.14 EntityMaps build — the named gap (no 5.14.1-5.14.3 routes)
  is closed. Configuration: integrated temporal + integrated Context Registry.'
robot: []
---
