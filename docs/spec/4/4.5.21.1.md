...
pages: '75'
status: implemented
evidence: 'ListProperty is a first-class ATTR_TYPES member (expand.rs); normalized and concise forms share
  expand_instance; simplified/temporal renderings recorded under 4.5.4/4.5.9. Unit test: expand::tests::list_property_and_relationship_rules.
  Extension TP 4522_01_03 green against the local memory broker (official suite has zero List coverage).'
notes: ''
robot: []
---
