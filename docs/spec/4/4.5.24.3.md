...
pages: '79'
status: implemented
evidence: 'expand.rs: concise type inference from json member (test json_property_rules); TP 4524_01_01
  (verbatim round-trip, no value/unitCode leak)'
notes: '2026-08-10: json never term-expanded/compacted — asserted with @context-term inner keys.'
robot:
- '4524_01'
---
