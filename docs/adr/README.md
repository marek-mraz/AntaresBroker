...
| [ADR-0014](https://github.com/marek-mraz/AntaresBroker/blob/master/docs/adr/ADR-0014-extension-hooks-model.md) | extension hooks — fixed phases, batch granularity | accepted |
